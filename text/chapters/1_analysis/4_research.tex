...
zaměřených na detekci barev s využitím i bez využití rozěířené reality a práci s paletami. Do výběru byly zařazeny aplikace, které splňovaly alespoň jednu z klíčových funkcionalit pro navrhovanou 
