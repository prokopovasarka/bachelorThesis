...
S významným názorem přišel v 18. století Isaac Newton ve své knize \emph{Optika}. Kniha dokumentuje Newtonovy pokusy znázorňující lom světla
skrze hranol. Jeho pozorování přineslo názor, že barva je viditelná část elektromagnetického spektra. Díky tomu můžeme rozeznávat různé barvy,
identifikoval také konkrétní odstíny: červenou, oranžovou, žlutou, zelenou, modrou, indigo a fialovou. %https://library.si.edu/exhibition/color-in-a-new-light/science
I přesto se ve své době nesetkal vždy s pozitivním ohlasem. Mnozí umělci stále věřili, že barva je něco mnohem komplexnějšího. Barvá má průhlednost, může být leská i matná,
disponuje texturou i odstínem. Všechny tyto složky jsou důležitými aspekty, které nám dohromady vytváří svět tak, jak jej vidíme.
