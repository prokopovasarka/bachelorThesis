...
Díky uživatelskému testování vyplynulo několik užitečných návrhů pro budoucí možný rozvoj aplikace.
...
jeden s prioritou \textit{could have}. Jelikož se jedná o požadavky, které plynule navazují na již implementované funkcionality, bylo by vhodné, i díky jednoduchosti integrace, implementovat je jako jedny z prvních.