Cílem této bakalářské prác bylo vytvořit multiplatformní aplikace detekující barvy z kamery 
...
proběhlo sestavení funkčních a nefunkčních požadavků spolu s případy užití. Kapitlo byla zakončena sestavením stavového 
diagramu.
...
dle funkcionalit. Pro implementaci bylo zvoleno IDE VScode, spolu s Xcode a frameworkem Expo pro sestavení a pro využití rozšířené reality se nejvhodnější volbou stala Viro knihovna. 
...
V závěru proběhlo zhodnocení výsledků práce a na základě výsledků testování a vyhodnocení plnění funkčních požadavků byla kapitola zakončena možným 
rozvojem aplikace v budoucnu.

Tak byly veškeré dílčí cíle a hlavní cíl splněny, tedy došlo i k splnění zadání této bakalářské práce.