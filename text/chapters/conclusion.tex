Cílem této bakalářské práce bylo vytvořit multiplatformní aplikaci detekující barvy z kamery 
za pomocí rozšířené reality a vytváření odpovídajících barevných schémat. To zahrnuje provedení analýzy, 
vytvoření návrhu, implementaci, testování aplikace a následné vyhodnocení výsledků s návrhem dalšího možného 
rozvoje aplikace.
...
V druhé kapitole proběhlo zvolení využívaných technologií a zvážení dalších možných řešení. Následovalo porovnání návrhových vzorů a došlo ke zvolení vhodné architektury spolu s návrhovým vzorem vyvíjené aplikace tak, aby 
vyhověla požadavkům, tedy monolitická architektura a \textit{Component-based} návrhový vzor. Poslední část se věnovala návrhu uživatelského rozhraní a vytvoření wireframů.
