...
odebrání má přitom minimální dopad na strukturu. Vývoj aplikací je sice náročnější proces, avšak i v případě komplikovanějších programů je tato analogie popisující
...
\mbox{}\\\mbox{}\\
Každý model však skýtá i určité \textbf{nevýhody} jeho využití.
