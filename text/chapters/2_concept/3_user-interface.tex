...
který uživatele dovede na hlavní obrazovku s menu, viz \ref{fig:first_wireframe}.
...
zda je aktuálně detekována barva, zda je kamera připravena či probíhá načítání.
...
\subsection{Library}
Z hlavní obrazovky je možné přistoupit na stránku s knihovnou uložených barev. Knihovna vyobrazuje čtverce s definovaným tvarem, je zachováno minimalistické prostředí. Při výběru barev je
...
kódy popisující barvu. Ve spodní části se nachází tři palety, které jsou jasně popsané názvem palety a ohraničené pro lepší odlišení od pozadí.
...
a zřejmost informací. Spodní tlačítko je nahrazeno zpětným tlačítkem v levém horním rohu, stejně jako je tomu ve zbytku aplikace. Wireframe obrazovky je vyobrazen na~\ref{fig:help_wireframe}.
