...
Pro zavedení CI do projektu a jeho verzování v průběhu celého vývoje bylo zvolené úložiště GitHub a proces jeho zavedení je popsaný v následující podeskci.
...
Následující popis fungováni workflow v GitHub Actions vychází z~\cite{github_actions_docs}. Workflow je konfigurovatelný automatizovaný proces, při němž se spouští jeden či více procesů. Je definovaný souborem YAML uloženým 
